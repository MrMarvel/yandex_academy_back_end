...
public class DeleteApiController implements DeleteApi {
    ...
    public ResponseEntity<Void> deleteIdDelete(@Parameter(in = ParameterIn.PATH, description = "Идентификатор", required=true, schema=@Schema()) @PathVariable("id") String id,@NotNull @Parameter(in = ParameterIn.QUERY, description = "Дата и время запроса" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "date", required = true) OffsetDateTime date) {
